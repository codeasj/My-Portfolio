...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      {/* Main card */}
      <div className="relative z-10 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 group-hover:scale-105 group-hover:border-slate-300 dark:border-slate-800 dark:bg-slate-900 dark:group-hover:border-slate-700 h-full flex flex-col">
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="flex-1 min-w-0 flex flex-col">
            <h3 className="font-semibold text-slate-900 transition-colors duration-300 group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400 line-clamp-2">
              {title}
            </h3>
            {subtitle && (
              <p className="mt-1 text-sm text-slate-600 transition-colors duration-300 group-hover:text-slate-800 dark:text-slate-400 dark:group-hover:text-slate-200 truncate">
                {subtitle}
              </p>
            )}
            {url && (
              <p className="mt-2 text-xs text-blue-600 transition-all duration-300 group-hover:text-blue-700 dark:text-blue-400 dark:group-hover:text-blue-300 truncate">
                {url}
              </p>
            )}
          </div>
